    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-4 bg-white">
        <div className="text-center">
          <p className="mb-4">Thank you for your time taking this survey. Some participants (including you) were given a short survey, without follow-up questions. You will still receive payment for t[..]</p>
    ...
    <div className="max-w-5xl mx-auto px-4">
      ...
      <div className="px-4 py-8 space-y-8">
        <div className="text-center">
          ...
          <p className="text-base mt-2">To choose, select Buy next to the one that is best for you. On this screen, you can choose any option (any of the 3 iPhones) or you can click learn more or othe[..]</p>
        </div>
